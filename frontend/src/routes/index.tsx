...
import ClienteServico from '../pages/Vincular/ServCliente'
import ClienteProduto from '../pages/Vincular/ProdCliente'
...
import ConsumoGeneros from '../pages/Consumos/ConsGenero/index'
import ConsumoValor from '../pages/Consumos/ConsValor/index'
import ConsumoMenor from '../pages/Consumos/ConsMenos/index'
import ConsumoPSConsumido from '../pages/Consumos/ConsMaiorPS/index'
import ConsumoConsumidor from '../pages/Consumos/ConsMaiorQnt/index'
